...
?>
    <title>ESO ES Onlus | Area Riservata
    </title>
  ...
  <body>
    <div class="esterno">
      ...
      <div class="contenitore text-center">
        <div id="popup">
          <span id="btn-hide" class="fas fa-angle-up">
          </span>
          <strong>Selezionare l'immagine da caricare
          </strong>
        ...
        <button id="cambia_immagine" class="btn btn-primary float-right">Cambia immagine
        </button>
        <br>
...
?>
        ...
        <div class="text-right">
          <button id="submit-name" class="btn btn-primary">Cambia nome
          </button>
          <button id="cancel-name" class="btn btn-danger" style="display:none;">Annulla
          </button>
          <br>
          <span id="change-pwd" class="text-right">o 
            <a href="#new-pwd" class="blue">Cambia password
            </a>
          </span>
        </div>
...
?>
        ...
        <div class="text-right">
          <button id="change-mail" class="btn btn-primary">Cambia E-mail
          </button>
          <button id="cancel-mail" class="btn btn-danger" style="display:none;">Annulla
          </button>
          <br>
        </div>
        <form id="pwd" class="text_center" style="display:none; margin:auto;">
          <span class="bold">Inserire la nuova password:
          </span> 
          <input type="password" id="new-pwd" class="text_input small_text">
          </p>
        <span class="bold">Confermare la nuova password:
        </span>
        <input type="password" id="confirm-pwd" class="text_input small_text">
        <br>
...
?>
      ...
      <div class="text-right">
        <button id="submit-frase" class="btn btn-primary text-right">Cambia la tua frase
        </button>
        <button id="cancel-frase" class="btn btn-danger" style="display:none;">Annulla
        </button>
      </div>
      <div class="presenze">
        <h3>*** Eventi a cui partecipi ***
        </h3>
        <table class="table">
          <thead class="bg-blue white">
            <tr>
              ...
              <th scope="col">Indirizzo
              </th>
              <th scope="col">Data
              </th>
              <th scope="col">Ora inizio
              </th>
            </tr>
          </thead>
          <tbody>
